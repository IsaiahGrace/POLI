...
set MODEL_INCLUDE_FILE   ${SRC_DIR}/models/spectre/all_models.scs
...
define_leafcell -type nmos -pin_position {0 1 2 3} { nsoi1 }
define_leafcell -type pmos -pin_position {0 1 2 3} { psoi1 }
#define_leafcell -type diode -pin_position {0 1} { g45nd1svt g45pd1svt }

define_cell \
       -input { A B orient } \
       -output { X } \
       -pinlist { A B orient X } \
       dig_poly_XOR_BUF2_x1
